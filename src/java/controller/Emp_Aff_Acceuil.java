 ...
 */
@WebServlet(name = "emAcceuil", urlPatterns = {"/emAcceuil"})
public class Emp_Aff_Acceuil extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       RequestDispatcher disp = request.getRequestDispatcher("Employer.jsp");

<%-- 
    Document   : Val_Encour_Aff_Acceuil
    Created on : 31 mars 2023, 07:07:38
...
<div class="row">
    ...
    <div class="col-md-12 text-center">
        <h3>Liste des requêtes en cour de traitement</h3>
    </div>
</div>
            ...
            <tbody>
                <c:forEach items="${valsen}" var="vali">
                    <tr>
                        ...
                        <td>${vali.date}</td>
                         <c:choose>
                            <c:when test="${vali.statu_per.equals('En cour')}">
                                <td><div class="badge bg-secondary">${vali.statu_per}</div></td>

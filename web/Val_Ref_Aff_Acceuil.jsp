<%-- 
    Document   : Val_Ref_Aff_Acceuil
    Created on : 26 avr. 2023, 20:24:53
...
<div class="row">
    <div class="col-md-12 text-center">
        <h3>Liste des requêtes refusées</h3>
    </div>
</div>
            ...
            <tbody>
                <c:forEach items="${valsen}" var="vali">
                    <tr>
                        ...
                        <td>${vali.date}</td>
                         <c:choose>
                            <c:when test="${vali.statu_per.equals('Refuse')}">
                                <td><div class="badge bg-danger">${vali.statu_per}</div></td>
